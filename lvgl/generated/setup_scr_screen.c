...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_sw_1, 165, 111);
    lv_obj_set_size(ui->screen_sw_1, 80, 45);
    ...
    lv_label_set_text(ui->screen_label_1, "第一个lvgl页面");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 92, 41);
    ...
    lv_obj_set_pos(ui->screen_bar_1, 67, 194);
    lv_obj_set_size(ui->screen_bar_1, 168, 19);
